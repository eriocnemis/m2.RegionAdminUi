...
namespace Eriocnemis\RegionAdminUi\Ui\Component;
...
class MassAction extends AbstractComponent
{
    ...
    public function isAllowed($actionType): bool
    {
        ...
        switch ($actionType) {
            case 'delete':
                $isAllowed = $this->authorization->isAllowed('Eriocnemis_Region::region_delete');
                break;
            case 'status':
                $isAllowed = $this->authorization->isAllowed('Eriocnemis_Region::region_edit');
                break;
        }
        return $isAllowed;
    }
